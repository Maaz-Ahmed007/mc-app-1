...
export const PaymentModal: React.FC<PaymentModalProps> = ({
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (selectedPayment) {
                await axios.patch(`/api/${params.sectionId}/labor-payments?id=${selectedPayment.id}`, paymentData)
                toast.success("Payment updated successfully")
            } else {
                await axios.post(`/api/${params.sectionId}/labor-payments`, paymentData)
